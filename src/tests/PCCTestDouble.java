...
public class PCCTestDouble {
	private void comparateurAlgorithmiqueResultat(IGraph g) {
		for (String i : g) {
        	for (String j : g) {
        		if (!i.equals(j)) {
        			try {
	...
	private void comparateurAlgorithmiqueThrows(IGraph g) {
		for (String i : g) {
        	for (String j : g) {
        		if (!i.equals(j)) {
	...
	public void comparateurAlgorithmique(IGraph g) {
